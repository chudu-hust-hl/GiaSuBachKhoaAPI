...
{
    public class GetStudentReqList
    {
        ...
        {
            GSGetStudentReqListRes objRes = new GSGetStudentReqListRes
            {
                RespCode = -1,
                RespText = "Nothing",
                TotalRows = 0,
            ...
            try
            {
                ...
                using (DataClassesGiaSuBKDataContext db = new DataClassesGiaSuBKDataContext())
                {
                    ...
                    // Fetch Student List
                    var studentListData = db.GS_GetStudentLst(objReq.PageNumber, objReq.RowsPage, objReq.Search).ToList();
