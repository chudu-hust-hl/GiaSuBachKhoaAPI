...
{
    public class GetFindingClassList
    {
        ...
        {
            GSGetFindingClassListRes objRes = new GSGetFindingClassListRes
            {
                RespCode = -1,
                RespText = "Nothing",
                TotalRows = 0,
            ...
            try
            {
                ...
                using (DataClassesGiaSuBKDataContext db = new DataClassesGiaSuBKDataContext())
                {
                    ...
                    // Fetch Class List
                    var classListData = db.GS_GetFindingClassLst(objReq.PageNumber, objReq.RowsPage, objReq.Search).ToList();
